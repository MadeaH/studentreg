...
namespace studentreg
{
    public partial class main: Form
    {
        ...
        private void addToLists()
        {
            ...
            std_list_datagrid.Rows.Add(id_input.Text, ln_input.Text, mn_input.Text, fn_input.Text,
                program_input.Text, year_input.Text,
                gender_input.Text, bdate_input.Value.ToShortDateString(), address_input.Text,
                nationality_input.Text, civilstatus_input.Text, contactnum_input.Text,
                transferee_input.Checked.ToString(),
                religion_input.Text,
                gln_input.Text, gmn_input.Text, gfn_input.Text, gnnumber_input.Text);
        ...
        // REGISTER BUTTON BECAUSE I CANT SEE SHIT
        ...
        // SKIBIDI SEARCH BAR FOR STUDENT LIST GRAAAAAAAAAAAAA
        ...
        private void att_search_btn_Click(object sender, EventArgs e)
        {
            ...
            foreach (var std in students)
            {
                if (std.std_id.ToLower().Contains(searched) || std.std_fullname.ToLower().Contains(searched))
                {
                    ...
                    std_list_datagrid.Rows.Add(std.std_id, std.std_fullname, combined_pys);
                }
            }
        }
